...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Categories of vehicles';
...
export interface ApiVehicleVehicle extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Collection of cars and vehicles';
    displayName: 'Vehicle';
    pluralName: 'vehicles';
  ...
  attributes: {
    ...
    equipments: Schema.Attribute.JSON;
    gallery: Schema.Attribute.Media<'images', true>;
    galleryUrls: Schema.Attribute.JSON;
    ...
    originalLink: Schema.Attribute.String;
